...
[] execVM "addons\restrict3rd\restrict3rd.sqf";
...
_action = ['WLMenu','Wasteland Menu','client\icons\playerMenu.paa',{player execVM "client\systems\playerMenu\init.sqf";},{true}] call ace_interact_menu_fnc_createAction;

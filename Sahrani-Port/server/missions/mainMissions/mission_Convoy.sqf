...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["CUP_O_UAZ_MG_TKA", "CUP_O_UAZ_Open_TKA", "CUP_O_UAZ_AGS30_TKA"],
		["CUP_O_UAZ_SPG9_TKA", "CUP_B_HMMWV_M2_USA", "CUP_I_Datsun_PK_TK_Random"],
		["CUP_I_Datsun_PK_TK", "CUP_B_HMMWV_Crows_MK19_USA", "CUP_B_HMMWV_SOV_USA"]

...
_setupObjects =
{
	...
	{
		["CUP_O_Datsun_PK", "SUD_TRUCK5t", "CUP_I_UAZ_SPG9_UN"]
	}
	else
	{
		[
			["B_Quadbike_01_F", "C_Van_01_box_F", "B_Quadbike_01_F"],
			["CUP_O_Datsun_PK_Random", "CUP_O_Ural_Open_TKA", "CUP_O_Ural_ZU23_TKA"]
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "CUP_I_UAZ_SPG9_UN" ):
			{
				_soldier = [_aiGroup, _position] call createRandomSoldier;
				_soldier moveInGunner _vehicle;
			};
			case (_type isKindOf "CUP_O_Datsun_PK" ):
			{
				_soldier = [_aiGroup, _position] call createRandomSoldier;
				_soldier moveInGunner _vehicle;
			};
			case (_type isKindOf "CUP_O_Ural_ZU23_TKA" ):
			{
				_soldier = [_aiGroup, _position] call createRandomSoldier;
				_soldier moveInGunner _vehicle;
			};

...
_uniformTypes = ["U_IG_Guerilla2_1", "U_IG_Guerilla2_1" ,"U_IG_Guerilla2_1"];
_vestTypes = ["V_Chestrig_rgr","V_Chestrig_blk"];
_weaponTypes = ["hlc_rifle_ak12","hlc_rifle_rpk","hlc_rifle_psg1","hlc_rifle_ak12gl"];
